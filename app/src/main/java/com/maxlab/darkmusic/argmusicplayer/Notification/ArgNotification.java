package com.maxlab.darkmusic.argmusicplayer.Notification;
...
public class ArgNotification extends Notification {
    ...
    public ArgNotification(Context context, @NonNull ArgNotificationOptions options) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel channel = new NotificationChannel("DarkMusic-" + context.getPackageName(), "DarkPlayer", NotificationManager.IMPORTANCE_DEFAULT);
            channel.setDescription("Notification from DarkPlayer");
