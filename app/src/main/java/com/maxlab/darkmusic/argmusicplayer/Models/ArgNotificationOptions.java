package com.maxlab.darkmusic.argmusicplayer.Models;
...
import com.maxlab.darkmusic.argmusicplayer.Callbacks.OnBuildNotificationListener;
...
public class ArgNotificationOptions {
    ...
    private int imageResoureId = R.drawable.mergesoft;
